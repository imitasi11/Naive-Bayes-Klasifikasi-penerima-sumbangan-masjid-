...
$tsql = 'SELECT * FROM parameter ORDER BY id_kriteria,id_parameter';
    ...
    <div class="features_area" style="margin-top: 40px;">
        <div class="container" style="padding-top: 100px;">
            <div class="row align-items-center justify-content-center">
                  ...
                  <form class="form-contact comment_form" action="aksi.php" method="post" enctype="multipart/form-data">
                     <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                           <div class="form-group" align="justify">
                            Alamat
                              <input class="form-control" name="alamat" id="alamat" type="alamat" placeholder="alamat">
                           </div>
                        </div>
      ...
      ?>
                     ...
                     <div class="form-group">
                        <button type="submit" name="upload" value="Input Data" class="button button-contactForm btn_1 boxed-btn">Input Data</button>
                     </div>
                  </form>
               </div>
            </div>
